...
<head>
    ...
    <style>
        ...
        .glass {
            ...
            border: 3px solid rgba(255, 255, 255, 0.55);   /* Thicker border */
...
<body class="text-white">
    ...
    <div class="glass">
        ...
        <h1 class="text-3xl font-bold text-center tracking-tight">Create Account</h1>
        <p id="welcome-text" class="text-center text-lg text-white/90 mt-2">Join Our Family</p>

        <form action="process_signup.php" method="POST" class="space-y-6 mt-8" id="signupForm">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="toggleDropdown()" id="roleButton" 
                        class="w-full px-5 py-4 rounded-2xl bg-white/20 border border-white/40 text-left text-white flex justify-between items-center hover:bg-white/30 transition-all">
